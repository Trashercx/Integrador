  ...
  <div class="bg-card shadow-lg rounded-lg overflow-hidden w-full max-w-4xl">
    <div class="flex flex-col md:flex-row items-center p-6 bg-primary text-primary-foreground">
      ...
      <div class="w-full md:w-1/2 md:pl-4">
        <h1 class="text-3xl font-bold mb-2">Descripción del evento</h1>
        <p id="event-description" class="text-muted-foreground" contenteditable>¡Únete a nosotros en este evento especial donde celebraremos juntos la magia de la comunidad! Habrá sorpresas, actividades emocionantes y mucho más. ¡No te lo pierdas!</p>
      </div>
    </div>
